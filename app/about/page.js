        ...
        <div className=''>
            ...
            <div className="flex md:flex-row sm:flex-col">
                ...
                <div className="flex flex-col sm:items-center sm:px-[10%] w-[50%] py-[5%] px-[4%] -mt-12">
                    ...
                    <p className="text-center text-gray-600 text-[23px] mt2">
