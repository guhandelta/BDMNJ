  ...
  return (
    ...
    <Image src={ContactImage} height={48} width={600} alt="Contact Us" className='w-full h-full mb-6' />
      ...
      <div className="flex flex-col items-center px-8">
        ...
        <input 
          type='submit' 
          className='w-full h-6 pt-4 pb-10 text-xl font-bold focus:outline focus:border-red-600 focus:outline-offset-2 hover:font-bold hover:text-white rounded-md hover:rounded-br-xl hover:rounded-tl-xl bg-gray-500 hover:bg-red-600 transition-all duration-300 ease-in-out'
          value='Submit'
        />
      </div>
